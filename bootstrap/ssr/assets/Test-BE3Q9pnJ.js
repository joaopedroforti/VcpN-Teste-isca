...
const Stepper = ({ step }) => /* @__PURE__ */ jsx("ul", { className: "flex items-center justify-between relative mx-10 before:content-[''] before:h-[3px] before:w-full before:absolute before:left-0 before:right-0 before:bg-purple-600", children: [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsx("li", { children: i <= step ? /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center bg-purple-600 h-6 w-6 text-white rounded-full relative z-10", children: /* @__PURE__ */ jsx(FaCheck, { className: "size-3" }) }) : /* @__PURE__ */ jsx("span", { className: "flex bg-white h-6 w-6 border-[3px] border-purple-600 rounded-full relative z-10" }) }, i)) });
...
const ScoreGroups = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-[#ededed] border border-purple-300 w-full relative px-8 pt-4 pb-6", children: [
    shouldShowAdvice && /* @__PURE__ */ jsx("p", { className: "bg-yellow-400 text-xs text-gray-600 w-fit rounded-full py-0.5 px-5 absolute left-2 top-2", children: "Preencha todos os campos" }),
    /* @__PURE__ */ jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: items.map(({ id, adjective, points }) => /* @__PURE__ */ jsxs("li", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsx("span", { className: "font-medium text-lg text-gray-800 line-clamp-1", children: adjective }),
      /* @__PURE__ */ jsx("div", { className: "flex gap-x-2 items-center", children: initialPoints.map((point) => {
        ...
        if (points === point) {
          const isRemainingMoreThanOnePoint = notSeletectedPoints.length > 1;
          return /* @__PURE__ */ jsx(
            "button",
            {
              className: cn(
              ...
              onClick: isRemainingMoreThanOnePoint ? () => removePoints(id) : void 0,
              title: point.toString(),
              type: "button",
              children: point
            },
...
const Header = forwardRef((_, ref) => /* @__PURE__ */ jsxs("header", { className: "bg-[#ededed] p-4", ref, children: [
  /* @__PURE__ */ jsx("p", { className: "font-bold text-center text-[#4d4c4c] max-w-md mx-auto mb-4", children: "Atribua notas de 1 a 4 para cada adjetivo, conforme ele se parece com você:" }),
  /* @__PURE__ */ jsxs("div", { className: "flex max-w-md mx-auto justify-between", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex gap-x-2 items-center text-sm text-black w-1/2 flex-nowrap whitespace-nowrap", children: [
        /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center h-8 min-h-8 w-8 min-w-8 bg-gray-50 border border-purple-600 font-bold text-xl text-gray-600", children: "1" }),
        "Não parece comigo"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-x-2 items-center text-sm text-black w-1/2 flex-nowrap whitespace-nowrap", children: [
        /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center h-8 min-h-8 w-8 min-w-8 bg-gray-50 border border-purple-600 font-bold text-xl text-gray-600", children: "2" }),
        "Parece pouco comigo"
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex gap-x-2 items-center text-sm text-black w-1/2 flex-nowrap whitespace-nowrap", children: [
        /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center h-8 min-h-8 w-8 min-w-8 bg-gray-50 border border-purple-600 font-bold text-xl text-gray-600", children: "3" }),
        "Parece comigo"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-x-2 items-center text-sm text-black w-1/2 flex-nowrap whitespace-nowrap", children: [
        /* @__PURE__ */ jsx("span", { className: "flex items-center justify-center h-8 min-h-8 w-8 min-w-8 bg-gray-50 border border-purple-600 font-bold text-xl text-gray-600", children: "4" }),
        "Parece muito comigo"
      ] })
    ] })
  ] })
...
const Test = () => {
  ...
  useDidUpdateEffect(() => {
    var _a;
    (_a = head.current) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
  }, [step]);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Teste de perfil comportamental" }),
    /* @__PURE__ */ jsx(Header, { ref: head }),
    /* @__PURE__ */ jsxs("main", { className: "flex flex-col max-w-md mx-auto px-4 py-6 lg:py-10", children: [
      /* @__PURE__ */ jsx("h1", { className: "sr-only", children: "Teste de perfil comportamental" }),
      /* @__PURE__ */ jsx(Stepper, { step }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-y-4 mt-6", children: scoreGroups }),
      isLastStep ? /* @__PURE__ */ jsx(Button, { className: "self-center mt-4 w-full md:w-min md:min-w-60", onClick: onFinishTest, title: "Finalizar", children: "Finalizar" }) : /* @__PURE__ */ jsxs(Button, { className: "self-center mt-4 w-full md:w-min md:min-w-60", onClick: onGoToNextStep, title: "Próximo", children: [
        "Próximo ",
        /* @__PURE__ */ jsx(FiChevronsRight, {})
      ] })
    ] })
  ] });
};
Test.layout = (page) => /* @__PURE__ */ jsx(AppLayout, { children: page });
export {
  Test as default
};
